  ...
  return show ? (
    ...
    <p>
      ...
      <div className='flex items-center flex-wrap gap-4 mt-4'>
        ...
        <a href="#dateSelect" className='px-10 py-3 text-sm bg-red-500 hover:bg-red-500 transition rounded-md font-medium cursor-pointer active:scale-95'>Buy Tickets</a>
        ...
        <DateSelect dateTime={show.dateTime} id={id}/>  
          ...
          <div className='flex justify-center mt-20'>
            <button onClick={() => {navigate('/movies'); scrollTo(0,0)}} className='px-10 py-3 text-sm bg-red-500 hover:bg-red-500 transition rounded-md font-medium cursor-pointer'>Show More</button>
          </div>
    </div>
  ) : <Loading />
}
